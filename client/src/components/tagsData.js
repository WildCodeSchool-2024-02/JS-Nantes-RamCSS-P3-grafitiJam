const tags = [
  {
    ...
    alt: "Flop",
    explanation:
      "Le flop est une version plus grande et lisible du tag.\n" +
      "\n" +
      "Il se réalise rapidement avec des formes simples et souvent en deux couleurs.",
  },
  {
    title: "Block Letter",
    image:
    ...
    alt: "Block Letter",
    explanation:
      "Le block letter est composé d'énormes lettres.\n" +
      "\n" +
      "Il est souvent réalisé le long des voies ferrées, autoroutes ou bâtiments désaffectés.",
  },
  {
    title: "Cartoon",
    image:
    ...
    alt: "Cartoon",
    explanation:
      "Le cartoon est un dessin destiné aux films d’animation ou bandes dessinées. \n" +
      "\n" +
      "Un graffiti au style cartoon se caractérise par des lignes simples aux couleurs vives et aux représentations rigolotes.",
  },
  {
    title: "Wildstyle",
    image:
      "https://raw.githubusercontent.com/WildCodeSchool-2024-02/JS-Nantes-RamCSS-P3-grafitiJam/main/server/public/assets/tags/wild.svg",
    alt: "Wildstyle",
    explanation:
      "Le wild style porte bien son nom : style sauvage. \n" +
      "\n" +
      " Le travail des lettres est poussé à l’extrême, à tel point que l’œuvre est quasiment illisible pour un œil non habitué.",
  },
  {
    title: "Tag",
    image:
    ...
    alt: "Tag",
    explanation:
      "Le tag est à la base de tous les autres styles. On le définit comme la signature du graffeur.\n" +
      "Celui-ci peut être réalisé rapidement et permet d’écrire un grand nombre de fois son pseudonyme.",
  },
];
