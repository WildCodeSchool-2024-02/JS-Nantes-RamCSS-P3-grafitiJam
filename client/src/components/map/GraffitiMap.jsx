...
function GraffitiMap() {
    ...
    useEffect(() => {
       fetch(`${import.meta.env.VITE_API_URL}/api/art`)
           .then((res) => res.json())
           .then((data) => setGraffitis(data));
       console.warn("Graffitis", graffitis);
    }, [graffitis]);
